...
import type { CreateExtensionPayload } from "../types";

interface RamalFormProps {
  onCreate: (data: CreateExtensionPayload) => Promise<void>;
}
...
const RamalForm: FC<RamalFormProps> = ({ onCreate }) => {
    ...
    <Box component="form" onSubmit={submit} sx={{ mb: 2 }}>
      <Stack direction={{ xs: "column", md: "row" }} spacing={1}>
        ...
        <TextField
          ...
          onChange={(e) =>
            setForm((prev) => ({ ...prev, sipPassword: e.target.value }))
          }
        ...
        <FormControl fullWidth>
          ...
          <Select
            ...
            onChange={(e) =>
              setForm((prev) => ({ ...prev, voipLineId: e.target.value }))
            }
          >
